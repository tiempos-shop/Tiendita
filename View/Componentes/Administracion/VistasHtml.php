...
class VistasHtml
{
    ...
    public function  MenuMovil($idioma, $idiomaActual,int $numeroProductosCarrito=0, $funcionMenuCLick = "cambiarLogoFijo()", $clase = '', $numPaginaActual = -1, $filtroActual = -1, $ordenamientoActual = -1)
    {
        ...
        $nav  = "<nav id='menu-movil-dorado' class='navbar navbar-inverse navbar-static-top position-fixed d-sm-block d-md-none d-block d-block bg-transparent ".$clase."' style='width: 100%; top:0; z-index: 2;left: 0;' role='navigation'>
                        <div class=''>
