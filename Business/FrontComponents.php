...
//            "</div>";
    ...
    public function SizeButton($botonTalla,$opcionesTallas){
        return '<div class="btn-group" style="width:100%">
                    <button type="button" class="btn btn-block dropdown-toggle" style="padding: 0 !important;" data-toggle="dropdown">
                      '.$botonTalla.'
                    </button>
    ...
    {
        return "<div id='politica' class='d-flex justify-content-around  d-none' style='position: ".$position."; ' ><span class='' onclick='go(\"privacy.php\")' > PRIVACY POLICY</span><span  onclick='go(\"shipping.php\")' class=''>SHIPPING & RETURNS</span></div>";
    }
