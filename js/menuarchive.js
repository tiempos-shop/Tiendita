...
function validarDimenciones() {
    ...
    document.getElementById('contenedorArchive').classList.add('ocultarmargen');
...
function cambiarLogoFijo(esEjecucionAutomatica = false)
{
    if (mostrarMenu & !esEjecucionAutomatica)
    {
        ...
        setTimeout(function() {
            ...
            document.getElementById('contenedorArchive').style.display = 'none';
    ...
    else
    {
        ...
        setTimeout(function() {
            ...
            document.getElementById('contenedorArchive').style.display = 'block';
